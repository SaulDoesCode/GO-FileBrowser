 ...
 *  Credit to Copyright (c) 2015 Massimo Artizzu (MaxArt2501)
 *  License MIT
...
if (window.Object["observe"] === undefined) {
  Object.observe || function(e, t, n) {
    "use strict";
    var r, o, i = ["add", "update", "delete", "reconfigure", "setPrototype", "preventExtensions"],
      s = t.isArray || function(e) {
        return function(t) {
          return "[object Array]" === e.call(t)
        }
      }(e.prototype.toString),
      c = t.prototype.indexOf ? t.indexOf || function(e, n, r) {
      ...
      a = "undefined" != typeof n.Map && Map.prototype.forEach ? function() {
        return new Map
      } : function() {
        var e = [],
          t = [];
        return {
          ...
          set: function(n, r) {
            var o = c(e, n); - 1 === o ? (e.push(n), t.push(r), this.size++) : t[o] = r
          },
          "delete": function(n) {
            var r = c(e, n);
      ...
      f = e.getOwnPropertyNames ? function() {
        ...
        try {
          ...
          var r = (t(c).join(" ") + " ").replace(/prototype |length |name /g, "").slice(0, -1).split(" ");
          r.length && (t = function(t) {
            var n = e.getOwnPropertyNames(t);
            if ("function" == typeof t)
              for (var o, i = 0; i < r.length;)(o = c(n, r[i++])) > -1 && n.splice(o, 1);
            return n
          })
        }
        return t
        ...
        return s(t) && o.push("length"), o
      },
      u = e.getPrototypeOf,
      p = e.defineProperties && e.getOwnPropertyDescriptor,
      l = n.requestAnimationFrame || n.webkitRequestAnimationFrame || function() {
        var e = +new Date,
          t = e;
        return function(n) {
      ...
      h = function(e, t, n) {
        var o = r.get(e);
        o ? j(e, o, t, n) : (o = d(e), j(e, o, t, n), 1 === r.size && l(v))
      },
      d = function(t, n) {
        var o, i = f(t),
          s = [],
        ...
        if (p)
          for (o = n.descriptors = []; c < i.length;) o[c] = p(t, i[c]), s[c] = t[i[c++]];
        else
          for (; c < i.length;) s[c] = t[i[c++]];
        return r.set(t, n), n
      },
      b = function() {
        var t = p ? function(e, t, n, r, o) {
            var i = t.properties[n],
              s = e[i],
              c = t.values[n],
              a = t.descriptors[n];
            "value" in o && (c === s ? 0 === c && 1 / c !== 1 / s : c === c || s === s) && (w(e, t, {
              name: i,
              type: "update",
              object: e,
              oldValue: c
            }, r), t.values[n] = s), !a.configurable || o.configurable && o.writable === a.writable && o.enumerable === a.enumerable && o.get === a.get && o.set === a.set || (w(e, t, {
              name: i,
              type: "reconfigure",
              object: e,
              oldValue: c
          ...
          n = p ? function(e, n, r, o, i) {
            for (var s, c = n.length; r && c--;) null !== n[c] && (s = p(e, n[c]), r--, s ? t(e, o, c, i, s) : (w(e, o, {
              name: n[c],
              type: "delete",
              object: e,
              oldValue: o.values[c]
            ...
            for (var i = t.length; n && i--;) null !== t[i] && (w(e, r, {
              name: t[i],
              type: "delete",
              object: e,
              oldValue: r.values[i]
        ...
        return function(r, o, i) {
          if (r.handlers.size && !r.frozen) {
            var s, a, l, h, d, b, v, g, y = r.values,
              j = r.descriptors,
              m = 0;
            if (r.extensible)
              if (s = r.properties.slice(), a = s.length, l = f(o), j) {
                for (; m < l.length;) d = l[m++], h = c(s, d), g = p(o, d), -1 === h ? (w(o, r, {
                  name: d,
                  type: "add",
                  object: o
                }, i), r.properties.push(d), y.push(o[d]), j.push(g)) : (s[h] = null, a--, t(o, r, h, i, g));
                n(o, s, a, r, i), e.isExtensible(o) || (r.extensible = !1, w(o, r, {
                  type: "preventExtensions",
                  object: o
                }, i), r.frozen = e.isFrozen(o))
              } else {
                for (; m < l.length;) d = l[m++], h = c(s, d), b = o[d], -1 === h ? (w(o, r, {
                  name: d,
                  type: "add",
                  object: o
                }, i), r.properties.push(d), y.push(b)) : (s[h] = null, a--, t(o, r, h, i));
                n(o, s, a, r, i)
              } else if (!r.frozen) {
              for (; m < s.length; m++) d = s[m], t(o, r, m, i, p(o, d));
              e.isFrozen(o) && (r.frozen = !0)
            }
            u && (v = u(o), v !== r.proto && (w(o, r, {
              type: "setPrototype",
              name: "__proto__",
              object: o,
              oldValue: r.proto
      ...
      v = function() {
        r.size && (r.forEach(b), o.forEach(g), l(v))
      },
      g = function(e, t) {
      ...
      y = function(e, t) {
        return arguments.length < 2 && (t = r.get(e)), t && t.notifier || {
          ...
          performChange: function(t, n) {
            ...
            if (s && b(s, e, t), s && c && "object" == typeof c) {
              i = {
                object: e,
                type: t
              };
              for (o in c) "object" !== o && "type" !== o && (i[o] = c[o]);
              w(e, s, i)
            }
          }
        }
      ...
      w = function(e, t, n, r) {
        t.handlers.forEach(function(t) {
          ...
          ("string" != typeof r || -1 === c(o, r)) && c(o, n.type) > -1 && t.changeRecords.push(n)
        })
      };
    r = a(), o = a(), e.observe = function(t, n, r) {
      ...
      if (arguments.length > 2) {
        if (!r || "object" != typeof r) throw new TypeError("Object.observe cannot use non-object accept list")
      } else r = i;
      return h(t, n, r), t
      ...
      var n, i = o.get(t);
      return i && (n = i.observed.get(e)) && (i.observed.forEach(function(e, t) {
        b(e.data, t)
      }), l(function() {
        g(i, t)
      }), 1 === i.observed.size && i.observed.has(e) ? o["delete"](t) : i.observed["delete"](e), 1 === n.data.handlers.size ? r["delete"](e) : n.data.handlers["delete"](t)), e
